...
Tags:
  ...
  - Name: my-package
  - Name: thing
ReleaseNotes: Update test payload endpoint
CQCHookEndpoint: https://aaas-demo.nfdi4plants.org
---
*)"""

printfn "If you can read this in your console, you are executing test package v6.0.1!" 
...
printfn "If you can read this in your console, you successfully executed test package v6.0.1!" 